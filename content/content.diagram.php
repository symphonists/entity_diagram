<?php
	...
	Class contentExtensionEntity_DiagramDiagram extends AdministrationPage{	
		function view(){
			...
			Administration::instance()->Page->addStylesheetToHead(URL . '/extensions/entity_diagram/assets/erd.css', 'all', 271);
			Administration::instance()->Page->addScriptToHead(URL . '/extensions/entity_diagram/assets/erd.js', 274);
